...
# ── Provider Selection ────────────────────────────────────────────────────────
# "openai"  → OpenAI หรือ Azure OpenAI
# "google"  → Google Gemini
LLM_PROVIDER = os.getenv("LLM_PROVIDER", "openai")

# ── OpenAI / Azure OpenAI ─────────────────────────────────────────────────────
OPENAI_ENDPOINT         = os.getenv("OPENAI_ENDPOINT", "")          # Azure endpoint (ว่าง = OpenAI ปกติ)
OPENAI_MODEL_NAME       = os.getenv("OPENAI_MODEL_NAME", "gpt-5-mini")
OPENAI_DEPLOYMENT       = os.getenv("OPENAI_DEPLOYMENT", "gpt-5-mini")  # Azure deployment name
OPENAI_SUBSCRIPTION_KEY = os.getenv("OPENAI_SUBSCRIPTION_KEY", "")  # OpenAI API key หรือ Azure key
